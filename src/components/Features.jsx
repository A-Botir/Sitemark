...
const Features = () => {
  const [backgroundImage, setBackgroundImage] = useState("dash");
  ...
  return (
    <section className="mt-32 grid grid-cols-2 gap-12">
      <div>
        ...
        <div className="flex flex-col gap-4">
          <button
            ...
            className="hover:shadow-card flex items-center gap-5 rounded-[10px] border border-[#d6e2ebcc] p-6 transition duration-500 ease-in hover:border-[#55a6f6] hover:bg-[#55a6f64d] active:p-5"
          >
            <svg
      ...
      <div className="border  border-[#bfccd980] px-[65px] py-[55px]">
        <div
          className={`bg-[${backgroundImage}] h-full w-full bg-cover bg-no-repeat`}
        >
